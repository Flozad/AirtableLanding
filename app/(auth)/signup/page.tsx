      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h1 className="h1 text-gray-800">Welcome. We exist to make entrepreneurship easier.</h1>
          </div>
          ...
          <div className="max-w-sm mx-auto">
            ...
            <div className="text-gray-400 text-center mt-6">
              Already using Open PRO? <Link href="/signin" className="text-green-400 hover:text-gray-200 transition duration-150 ease-in-out">Sign in</Link>
            </div>
          </div>
