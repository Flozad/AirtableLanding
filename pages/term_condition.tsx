  ...
  return (
    <section className="bg-white py-12 md:py-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <p>Welcome to Clasicwebtools!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of Clasicwebtools.com's Website, located at Clasicwebtools.com.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Clasicwebtools if you do not agree
        ...
        <p>
          ...
          accordance with and subject to, prevailing law of ar. Any use of the
        ...
        <p>
          We employ the use of cookies. By accessing Clasicwebtools, you agreed
          to use cookies in agreement with the Clasicwebtools.com's Privacy
          Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, Clasicwebtools.com and/or its licensors own
          the intellectual property rights for all material on Clasicwebtools.
          All intellectual property rights are reserved. You may access this
          from Clasicwebtools for your own personal use subjected to
          restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Clasicwebtools</li>
          <li>Sell, rent or sub-license material from Clasicwebtools</li>
          <li>Reproduce, duplicate or copy material from Clasicwebtools</li>
          <li>Redistribute content from Clasicwebtools</li>
        </ul>
        ...
        <p>
          ...
          Clasicwebtools.com does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of Clasicwebtools.com,its agents and/or affiliates.
          ...
          Clasicwebtools.com shall not be liable for the Comments or for any
        ...
        <p>
          Clasicwebtools.com reserves the right to monitor all Comments and to
        ...
        <p>
          You hereby grant Clasicwebtools.com a non-exclusive license to use,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Clasicwebtools.com; and (d)
        ...
        <p>
          ...
          sending an e-mail to Clasicwebtools.com. Please include your name,
        ...
        <p>
          No use of Clasicwebtools.com's logo or other artwork will be allowed
